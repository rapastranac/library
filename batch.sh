...
mpirun --oversubscribe -n 2 -display-map --bind-to none --map-by core --report-bindings ./a.out -N 11 -I input/prob_4/600/00600_1
...
#mpirun --oversubscribe -n 50 -display-map --bind-to none --map-by core --report-bindings ./a.out -N 4 -I input/p_hat1000_2
